...
public class VakIXData
{
    ...
    // 1. Geïntegreerde woonbonus (leningen 2016–2019)
    public decimal? Code3334 { get; set; }   // interesten + kapitaalaflossingen
    public decimal? Code4334 { get; set; }
    public decimal? Code3335 { get; set; }   // premies levensverzekering
    public decimal? Code4335 { get; set; }
    public bool     Code3336 { get; set; }   // enige woning op 31.12.2025 – Ja
    public bool     Code4336 { get; set; }
    public bool     Code3337 { get; set; }   // enige woning op 31.12.2025 – Neen
    public bool     Code4337 { get; set; }
    public decimal? Code3330 { get; set; }   // aantal kinderen ten laste (op 1 jan na afsluiting)
    public decimal? Code4330 { get; set; }

    // 2. Gewestelijke woonbonus (leningen 2005–2015)
    // 2a: leningen 2015
    public decimal? Code3360 { get; set; }   // interesten + kapitaalaflossingen leningen 2015
    public decimal? Code4360 { get; set; }
    public decimal? Code3361 { get; set; }   // premies levensverzekering leningen 2015
    public decimal? Code4361 { get; set; }
    // 2b: leningen 2005–2014
    public decimal? Code3370 { get; set; }   // interesten + kapitaalaflossingen leningen 2005–2014
    public decimal? Code4370 { get; set; }
    public decimal? Code3371 { get; set; }   // premies levensverzekering leningen 2005–2014
    public decimal? Code4371 { get; set; }

    // 3. Andere interesten eigen woning — gewestelijke vermindering (Rubriek 3)
    public decimal? Code3100 { get; set; }   // KI niet verhuurd
    public decimal? Code4100 { get; set; }
    public decimal? Code3106 { get; set; }   // KI verhuurd nat. persoon
    public decimal? Code4106 { get; set; }
    public decimal? Code3109 { get; set; }   // KI andere omstandigheden
    public decimal? Code4109 { get; set; }
    public decimal? Code3110 { get; set; }   // brutohuur
    public decimal? Code4110 { get; set; }

    // 4. Interestaftrek hypothecaire leningen 1986–2005 (Rubriek 4)
    public decimal? Code3138 { get; set; }   // interesten enige woning – bouw/aankoop
    public decimal? Code4138 { get; set; }
    public decimal? Code3139 { get; set; }   // interesten vernieuwing (woning ≥15/20j)
    ...
    public int?     Code3142 { get; set; }   // aantal kinderen ten laste bij afsluiting
    public int?     Code4142 { get; set; }
    public string?  Code3144 { get; set; }   // datum ingebruikneming/voltooiing werken
    public string?  Code4144 { get; set; }
    public decimal? Code3145 { get; set; }   // kostprijs vernieuwingswerken
    public decimal? Code4145 { get; set; }
    public decimal? Code3148 { get; set; }   // aandeel in eigen woning (%)
    ...
    public bool     Code3137 { get; set; }   // eigen woning beide partners – Neen

    // 5. Andere interesten (vóór 2005 / schulden aangegaan vóór 2016) — Rubriek 5
    public decimal? Code3150 { get; set; }   // interesten leningen 2015
    public decimal? Code3146 { get; set; }   // interesten leningen vóór 2015
